# Triage Report Validation

## Summary

Defines requirements for validating triage report format compliance using template-based constraints and Stop hook validation in the k8s-troubleshooter skill.

## Related Capabilities

- **agent-container**: Uses k8s-troubleshooter skill with validation hooks
- **agent-execution**: Reports generated during triage runs must comply with format
...
None - this is a net-new capability that enhances but does not modify existing behavior.

---

## REMOVED Requirements

None - validation is additive and does not remove any existing capabilities.
